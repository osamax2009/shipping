!(function (e, t) {
        ...
        N =
            ...
            (L.prototype.setComponent = function (e) {
                ...
                if (((this.component = e), this.shouldAutoInitialize())) {
                    ...
                    try {
                        for (
                            var r = f(this.instancesDeferred.entries()),
                                i = r.next();
                            !i.done;
                            i = r.next()
                        ) {
            ...
            (L.prototype.getOptions = function (e) {
                return (
                    this.instancesOptions.get((e = void 0 === e ? C : e)) || {}
                );
            }),
            (L.prototype.initialize = function (e) {
                ...
                try {
                    for (
                        var a = f(this.instancesDeferred.entries()),
                            s = a.next();
                        !s.done;
                        s = a.next()
                    ) {
    ...
    function ee(e, t = {}) {
        ...
        var n = Object.assign(
            { name: V, automaticDataCollectionEnabled: !1 },
            t
        );
        const r = n.name;
    ...
    function ce(i) {
        ...
        function a(e) {
            if (((e = e || V), !v(n, e)))
                throw se.create("no-app", { appName: e });
            return n[e];
        }
        return (
            (o.default = o),
