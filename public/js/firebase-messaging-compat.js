        ...
        !function () {
                ...
                return (
                    i &&
                        (i.onupgradeneeded = function (e) {
                            n &&
                                n(new S(i.result, e.oldVersion, i.transaction));
                        }),
                    t.then(function (e) {
                        return new _(e);
                    })
                ...
                var e = await re(i.appConfig, (e) => {
                    ...
                    if (
                        ...
                        (function (e) {
                            ...
                            return (
                                t < e.creationTime ||
                                e.creationTime + e.expiresIn < t + E
                            );
                        })(t)
                    ) {
                ...
                new d(
                    ...
                    (e) => {
                        ...
                        return {
                            ...
                            platformLoggerProvider: Lt._getProvider(
                                e,
                                "platform-logger"
                            ),
                        ...
                        return Date.now() >= s.createTime + Re
                            ? (async function (t, e) {
                                  try {
                                      ...
                                      return (
                                          await Ne(t.firebaseDependencies, i), n
                                      );
                                  } catch (e) {
                                      throw (await He(t), e);
                                  }
            ...
            async function lt(a) {
                ...
                const e = await T(ut, pt, async (e) => {
                    ...
                    if (
                        !(e.oldVersion < 2) &&
                        e.objectStoreNames.contains(dt)
                    ) {
                        ...
                        return Date.now() >= s.createTime + Ct
                            ? (async function (t, e) {
                                  try {
                                      ...
                                      return (
                                          await bt(t.firebaseDependencies, i), n
                                      );
                                  } catch (e) {
                                      throw (await jt(t), e);
                                  }
            ...
            async function Pt(e, t) {
                t = (function (e, t) {
                    ...
                    (n.instance_id = t),
                        e.notification
                            ? (n.message_type =
                                  M.DISPLAY_NOTIFICATION.toString())
                            : (n.message_type = M.DATA_MESSAGE.toString());
                    (n.sdk_platform = rt.toString()),
                        (n.package_name = self.origin.replace(
                            /(^\w+:|^)\/\//,
                            ""
                        )),
                ...
                if (n) {
                    ...
                    n.notification &&
                        ...
                        t &&
                            ...
                            (a = i).notification &&
                                ((e.notification = {}),
                                (n = a.notification.title) &&
                                    (e.notification.title = n),
                                (n = a.notification.body) &&
                                    (e.notification.body = n),
                                (a = a.notification.image) &&
                                    (e.notification.image = a)),
                            (e = o),
            ...
            class xt {
                constructor(e, t, n) {
                    ...
                    var i = (function (e) {
                        if (!e || !e.options)
                            throw Nt("App Configuration Object");
            ...
            function Bt(e, t) {
                return (function (e, t) {
                    if (void 0 !== self.document)
                        throw kt.create("only-available-in-sw");
                    return (
                ...
                isSupported: function () {
                    return self && "ServiceWorkerGlobalScope" in self
                        ? "indexedDB" in self &&
                              ...
                              PushSubscription.prototype.hasOwnProperty(
                                  "getKey"
                              )
                        : "indexedDB" in window &&
                              null !== indexedDB &&
